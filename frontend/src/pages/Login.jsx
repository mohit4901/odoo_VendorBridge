  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 border-r border-zinc-900/60 p-16 flex-col justify-between relative overflow-hidden">
        ...
        <div className="my-auto max-w-lg space-y-6 relative z-10">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl leading-tight">
            Next-Gen Procurement & <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-indigo-400">Vendor Management</span>
          </h2>
        ...
        <div className="text-xs text-zinc-500 relative z-10 flex justify-between items-center">
          ...
          <span className="text-[10px] uppercase font-semibold text-violet-400 tracking-wider">Secure Node</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-16 lg:px-24 xl:px-32 relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-violet-500/5 rounded-full blur-[80px] pointer-events-none lg:hidden"></div>
        ...
        <div className="mx-auto w-full max-w-md space-y-6 relative z-10">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  defaultChecked
                  className="h-4 w-4 bg-zinc-950 border border-zinc-800 rounded text-violet-500 focus:ring-offset-black cursor-pointer"
                />
          ...
          <div className="text-center pt-2 text-xs">
            ...
            <Link to="/register" className="text-violet-400 font-semibold hover:text-violet-300 hover:underline">
              Onboard Vendor
            </Link>
          </div>
        </div>
