            ...
            <div className="h-44 w-full flex items-center justify-center">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={[
                      { name: 'IT Hardware', value: 480000, color: '#06b6d4' },
                      { name: 'Furniture', value: 320000, color: '#10b981' },
                      { name: 'Logistics', value: 230000, color: '#3b82f6' },
                      { name: 'Stationery', value: 210000, color: '#f59e0b' }
                    ]}
                    cx="50%"
                    cy="50%"
                    innerRadius={50}
